      ...
      <div className="content grid md:grid-cols-3 grid-cols-2 gap-x-4 gap-y-8">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-secondary md:text-base sm:text-sm text-xs text-justify">
            ...
            anything — with Node, Express, and database wizardry in my toolkit.
          </p>
        </div>
        <div className="flex flex-col">
          <FontAwesomeIcon
          ...
          <p className="text-secondary md:text-base sm:text-sm text-xs text-justify">
            ...
            Full-stack web dev with modern tools like React, Tailwind, and Node.
            I turn ideas into dope, working products.
          </p>
        </div>
        <div className="flex flex-col">
          <FontAwesomeIcon
        ...
        <div className="flex flex-col">
          ...
          <p className="text-secondary md:text-base sm:text-sm text-xs text-justify">
            I make sure your app’s brain doesn’t fry. With solid schema design,
            clean queries, and smooth API integration, I keep your data flowing
            — fast, reliable, and ready to scale. Mongo? SQL? Got it covered.
          </p>
        </div>
      </div>
    </div>
