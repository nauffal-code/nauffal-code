...
export default function Home() {
  ...
  const gridClassName = useMemo(
    () =>
      `grid md:grid-cols-3 grid-cols-2 items-start md:gap-x-4 md:gap-y-6 sm:gap-x-2 sm:gap-y-4 gap-x-1 gap-y-2 mt-6 mb-8 ${
      ...
      <main>
        ...
        <section>
          <article>
            ...
            <div className="flex gap-2">
              <button
                onClick={() =>
                  setRandomProjects(getRandomProjects(3, projects))
                }
              ...
              <Link
                href="/work"
                className="px-6 py-2 bg-transparent text-main border-2 border-main rounded-lg"
                aria-label="See all projects"
              >
                See All Projects<i className="fa-solid fa-angle-right"></i>
              </Link>
            </div>
          </article>
        </section>
        ...
        <section>
          <article>
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 gap-x-4 gap-y-8 mt-6">
